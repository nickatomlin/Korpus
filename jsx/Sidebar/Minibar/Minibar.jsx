	...
	return (
		<div id="minibar">
			<ul className="minibarTabs">
        		<li className="active"><a className="minibarLink" href="#info"><img src="/Korpus/images/info.svg" /></a></li>
        		<li><a className="minibarLink" href="#search"><img src="/Korpus/images/search.svg" /></a></li>
        		<li><a className="minibarLink" href="#settings"><img src="/Korpus/images/settings.svg" /></a></li>
    		</ul>
    		<div id="miniPage">
