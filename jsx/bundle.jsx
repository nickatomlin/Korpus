...
var LabeledSentence = function (_React$Component3) {
	_inherits(LabeledSentence, _React$Component3);
...
var TimeBlock = function (_React$Component4) {
	_inherits(TimeBlock, _React$Component4);
...
var LabeledTimeBlock = function (_React$Component5) {
	_inherits(LabeledTimeBlock, _React$Component5);
...
var TimedTextDisplay = function (_React$Component6) {
	_inherits(TimedTextDisplay, _React$Component6);
...
var UntimedTextDisplay = function (_React$Component7) {
	_inherits(UntimedTextDisplay, _React$Component7);
...
var CenterPanel = function (_React$Component8) {
	_inherits(CenterPanel, _React$Component8);
...
var Video = function (_React$Component9) {
	_inherits(Video, _React$Component9);
...
var TitleInfo = function (_React$Component10) {
	_inherits(TitleInfo, _React$Component10);
...
var TierCheckbox = function (_React$Component11) {
	_inherits(TierCheckbox, _React$Component11);
	...
	function TierCheckbox(props) {
		...
		var _this11 = _possibleConstructorReturn(this, (TierCheckbox.__proto__ || Object.getPrototypeOf(TierCheckbox)).call(this, props));
...
var TierCheckboxList = function (_React$Component12) {
	_inherits(TierCheckboxList, _React$Component12);
...
var SpeakerInfo = function (_React$Component13) {
	_inherits(SpeakerInfo, _React$Component13);
